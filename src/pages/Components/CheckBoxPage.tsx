...
const CheckBoxPage = () => {
    const codeSnippet = `import { Checkbox } from 'your-ui-library';

// Basic usage
<Checkbox 
  label="Accept terms and conditions" 
  onPress={(checked) => console.log('Checkbox checked:', checked)} 
/>
...
<TodoCheckbox
  ...
  completed={false}
  onToggle={(completed) => console.log('Todo completed:', completed)}
  emoji="📝"
  shape="square"
  borderRadius={4}
/>`;

    const checkboxPropertiesData = [
        {
            name: 'checked',
            type: 'boolean',
        ...
        },
        {
            name: 'containerStyle',
            type: 'ViewStyle',
            description: 'Style for the checkbox container'
        },
        {
            name: 'checkboxStyle',
            type: 'ViewStyle',
            description: 'Style for the checkbox itself'
        },
        {
            name: 'labelStyle',
            type: 'TextStyle',
        ...
        },
        {
            name: 'checkMarkColor',
            type: 'string',
            description: 'Color for the check mark'
        },
        {
            name: 'disabledColor',
            type: 'string',
            description: 'Color for the disabled state'
        },
        {
            name: 'showCheckMark',
            type: 'boolean',
            description: 'Whether to show the check mark'
        },
        {
            name: 'checkMarkIcon',
            type: 'React.ReactNode',
            description: 'Optional icon to use as the check mark'
        },
        {
            name: 'controlled',
            type: 'boolean',
            description: 'Whether the component can be controlled or not'
        },
        {
            name: 'shape',
            type: "'round' | 'square'",
            description: 'Shape of the checkbox: round or square'
        },
        {
            name: 'borderRadius',
            type: 'number',
            description: 'Border radius for square shape (has no effect if shape is round)'
        },
        {
            name: 'borderWidth',
            type: 'number',
        ...
        },
        {
            name: 'checkMarkStyle',
            type: "'line' | 'check'",
            description: 'Style of the checkmark: line or check'
        },
        {
            name: 'withShadow',
            type: 'boolean',
    ...
    const todoCheckboxPropertiesData = [
        {
            name: 'text',
            type: 'string',
            description: 'Text to display for the todo item'
        },
        {
            name: 'completed',
            type: 'boolean',
        ...
        },
        {
            ...
            description: 'Callback when the todo completion status changes'
        },
        {
            name: 'containerStyle',
            type: 'ViewStyle',
        ...
        },
        {
            name: 'textStyle',
            type: 'TextStyle',
            description: 'Style for the text'
        },
        {
            name: 'checkedColor',
            type: 'string',
            description: 'Color for the checkbox when checked'
        },
        {
            name: 'disabled',
            type: 'boolean',
            description: 'Whether the todo item is disabled'
        },
        {
            name: 'controlled',
            type: 'boolean',
            description: 'Whether the component is controlled externally'
        },
        {
            name: 'children',
            type: 'React.ReactNode',
            description: 'Additional content to render'
        },
        {
            name: 'emoji',
            type: 'string',
            description: 'Emoji or icon to show at the end of the text'
        },
        {
            name: 'shape',
            type: "'round' | 'square'",
        ...
        },
        {
            name: 'borderRadius',
            type: 'number',
            description: 'Border radius for square checkbox'
        },
        {
            name: 'withShadow',
            type: 'boolean',
    ...
    const sections = [
        {
            id: 'introduction',
            title: 'Checkbox',
            content: "Checkboxes allow users to select one or more items from a set. Our customizable checkbox components are designed to work seamlessly in various contexts, from simple forms to complex todo lists."
        },
        {
            id: 'key-features',
            title: 'Key Features',
            features: [
                {
                    ...
                    description: 'Choose between square and round checkbox styles with customizable border radius.'
                },
                {
                    title: 'Customizable Appearance',
                    description: 'Extensive styling options including colors for checked, unchecked, and disabled states, size customization, and shadow effects.'
                },
                {
                    title: 'Animation Support',
                    description: 'Smooth transitions with configurable animation duration for better user experience.'
                },
                {
                    title: 'Todo Integration',
                    description: 'Specialized TodoCheckbox component with additional features like emoji support and text styling options.'
                },
                {
                    title: 'Check Mark Variations',
                    description: 'Different check mark styles (line or check) and support for custom check mark icons.'
                }
            ]
        },
        {
            ...
            content: () => (
                <TabsComponent
                    previewSrc="http://localhost:8081/checkbox/checkbox"
        ...
        },
        {
            ...
            content: "The Checkbox component accepts the following properties:",
            properties: checkboxPropertiesData
        },
        {
            id: 'todo-checkbox-properties',
            title: 'TodoCheckbox Properties',
            content: "The TodoCheckbox component accepts the following properties:",
            properties: todoCheckboxPropertiesData
        }
    ];
