...
export const UnderwaterBackground: React.FC = () => {
    return (
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-blue-900/80 via-blue-800/60 to-blue-950/90" />
            ...
            {/* Animated bubbles - reduced number and simplified */}
            {[...Array(3)].map((_, i) => (
                <div
                    key={i}
                    ...
                    style={{
                        ...
                        top: `${Math.random() * 100}%`,
                        animation: `floatBubble ${Math.random() * 8 + 5}s linear infinite`,
